<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YeniAltKullaniciEkle.aspx.cs" Inherits="Bayi_YeniAltKullaniciEkle" %>
...
<head runat="server">
    ...
    <script src='<%= "js/YeniAltKullaniciEkle.js?ver="+DateTime.Now.ToShortDateString()  %>' type="text/javascript"></script>
    <script type="text/javascript" src="<%= ResolveClientUrl("~/js/asistan.custom.js") %>"></script>

</head>
<body>
    <form id="pgAltAracEkle" runat="server">
        <div class="modal_dialog" style="width: 800px;">
            <div class="header">
                <span>YENİ KİTAP EKLE</span><div class="close_me">
            ...
            <div id="wizard" class="swMain">
                ...
                <div class="content" id="step-1">
                    <div class="section">
                        ...
                        <div>
                            <div style="max-width: 349px;">
                                <select id="ddlKitapTürleri" class="combox" style="display: inline-block">
                    ...
                    <a id="btnKaydet" onclick="KitapEkle()" class="buttonFinish">Kaydet</a>
                    <%--        <a href="#" id="btnIleri" class="buttonNext">Sonraki</a>
                    <a href="#" class="buttonPrevious buttonDisabled">Önceki</a>
                    --%>
                </div>
                <%--     
                <div class="section last" style="display:none" >
                    <div style="float: left; width: 50%;">
                        <div id="lblAracDetayID" runat="server" style="display:none" ></div>
                        <div id="lblMarkaID" runat="server" style="display:none" ></div>
                        <div id="lblModelID" runat="server" style="display:none" ></div>
                        <div id="lblSeriID" runat="server" style="display:none" ></div>
                    </div>
